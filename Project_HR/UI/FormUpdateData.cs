...
namespace BackOfficeApplication.Project_HR.UI
{
    public partial class FormUpdateData : DevExpress.XtraEditors.XtraForm
    {
        ...
        private int iDepartment = 0;
        private int iUser = 0;
        private int iCHeckIn = 0;
        ...
        private void FormUpdateData_Load(object sender, EventArgs e)
        {
            ...
            this.cboTypeOfImportData.SelectedIndex = 0;
        }
        ...
        private void updateCheckIN()
        {
            try
            {
                ...
                for (iCHeckIn = 1; iCHeckIn < dgvCHECKIN.Rows.Count - 1; iCHeckIn++)
                {
                    ...
                    bg_CHECKIN.ReportProgress(percentage);
        ...
        #region UPDATE USER WITH NO NAME
        ...
        private void updateUSER()
        {
            try
            {
                for (iUser = 0; iUser < dgvUSERINFO.Rows.Count - 1; iUser++)
                {
                    ...
                    bg_USER.ReportProgress(percent);
        ...
        #endregion UPDATE USER WITH NO NAME
        ...
        private void updateDepartment()
        {
            try
            {
                for (iDepartment = 0; iDepartment < dgvDEPT.Rows.Count - 1; iDepartment++)
                {
                    ...
                    bg_DEPT.ReportProgress(percent);
        ...
        private void bg_CHECKIN_DoWork(object sender, DoWorkEventArgs e)
        {
            updateCheckIN();
        }

        private void bg_CHECKIN_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
        ...
        private void bg_CHECKIN_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
        ...
        private void bg_USER_DoWork(object sender, DoWorkEventArgs e)
        {
            updateUSER();
        }

        private void bg_USER_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
            ProgressBarUSER.Value = e.ProgressPercentage;
            lblProgressbarUSER.Text = e.ProgressPercentage.ToString() + "%";
        }

        private void bg_USER_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            lblUserCount.Visible = false;
            ProgressBarUSER.Value = 100;
            lblProgressbarUSER.Text = "100%";
            bg_DEPT.RunWorkerAsync();
        }

        private void bg_DEPT_DoWork(object sender, DoWorkEventArgs e)
        {
            updateDepartment();
        }

        private void bg_DEPT_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
            ProgressBarDepartment.Value = e.ProgressPercentage;
            lblProgressbarDepartment.Text = e.ProgressPercentage.ToString() + "%";
        }

        private void bg_DEPT_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            lblDeptCount.Visible = false;
            ProgressBarDepartment.Value = 100;
            lblProgressbarDepartment.Text = "100%";
            bg_CHECKIN.RunWorkerAsync();
            //SplashScreenManager.CloseForm();
        }
    }
}